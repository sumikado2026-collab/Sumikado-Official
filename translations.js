...
window.translations = {
    ...
    'ja': {
        ...
        'beautology-lesson-1-title': '第1講：産後の気血をどう整える？母乳の考え方から学ぶ、女性の滴養',
        'beautology-tag-hot': '人気記事',
        'beautology-lesson-1-subtitle': '—— 産後のリセットから、気血をいたわる毎日の考え方へ ——',
        'beautology-lesson-1-desc': '妊娠、出産、授乳は、女性の体にとって大きな節目です。産後のケアは無理な滋養ではなく、少しずつ自分のリズムと元気を取り戻すことから始まります。',
        'beautology-l1-s1-title': '1. 産後のケアは、まず脾胃をいたわることから',
        'beautology-l1-s1-text': '漢方では「脾胃は後天の本」と考えます。食べられること、消化できることが、毎日の栄養を生かす土台です。重すぎる食事は、かえって負担になることもあります。',
        'beautology-l1-s2-title': '2. なぜ小分子の栄養に注目するの？',
        ...
        'beautology-lesson-2': '第2講：妊活前に体をどう整える？烏骨鶏チキンエッセンスが育む力の土台になる理由',
        'beautology-lesson-3': '第3講：なぜチキンエッセンスに烏骨鶏を選ぶ？黒い宝の食養と、内側からの輝き',
        'beautology-lesson-4': '第4講：産後60日をどう過ごす？体力と顔色を整えるためのResetプラン',
        'beautology-l2-subtitle': '—— まず自分を整えてこそ、育むためのゆとりが生まれる ——',
        'beautology-l2-desc': '育む準備は、睡眠、食事、気持ち、そして毎日の元気から始まります。漢方では、体を土にたとえます。土が潤ってこそ、種はしっかり根を張れます。',
        'beautology-l2-s1-title': '1. 妊活前のケアは、脾胃と元気を整えることから',
        ...
        'beautology-l2-s2-text': '烏骨鶏は、漢方の食養で女性の毎日の滋養に親しまれてきた食材です。現代栄養学の視点でも、たんぱく質やアミノ酸を含む、バランスのよい食事の一部になります。',
        'beautology-l2-s3-title': '3. 澄韻：毎日の滴養で、育むための土台を',
        'beautology-l2-s3-text': '【澄韻｜オリジナル烏骨鶏チキンエッセンス】は、12時間の無水・弱火抽出で仕上げた、まろやかで飲みやすい一袋。忙しい毎日に、続けやすい栄養補給を届けます。',
        'beautology-l2-quote': '「まず土を整え、それから花を育てる。体が大切にされるとき、育む力は自然に生まれます。」—— HANA医師',
        'beautology-l3-subtitle': '—— 本当の輝きは、顔だけでなく、日々の健やかさに宿る ——',
        'beautology-l3-desc': '外から見える輝きは、内側が丁寧に満たされたときに、少しずつ表れていくものです。',
        'beautology-l3-s1-title': '1. 烏骨鶏が「黒い宝」と呼ばれる理由',
        'beautology-l3-s1-text': '烏骨鶏は伝統的な食養で、女性の毎日の滋養に用いられてきました。大切なのは強い滋養ではなく、穏やかで、丁寧に積み重ねるケアです。',
        ...
        'beautology-l3-s3-title': '3. 滋養を、毎日の小さな儀式に',
        ...
        'beautology-l4-quote': '「子どもをケアする前に、あなた自身もやさしく待たれる存在だと、どうか忘れないでください。」—— HANA医師',
        'beautology-lesson-5': '第5講：チキンエッセンスは1日何袋？ライフステージ別の目安',
        ...
        'beautology-l5-safety-text': 'フェニルケトン尿症（高フェニルアラニン血症）や厳格な低たんぱく食が必要な先天代謝異常のある方は、自己判断で飲用しないでください。腎疾患、高尿酸血症・痛風、鶏肉アレルギー、妊娠・授乳中、産後出血後、術後の回復期、体重管理治療中の方は、医師または管理栄養士の助言に従ってください。お子さまは、パッケージに記載の対象年齢と摂取方法を確認し、食事や小児科での評価の代わりにはしないでください。',
        'beautology-l5-quote': '「毎日1袋は、活力をいたわる日常。増やすときも、体の本当の声に耳を傾けて。」—— HANA医師',
        'beautology-l5-cta': '公式LINEに登録して、スタッフに日々の食生活をご相談ください',
        'beautology-lesson-6': '第6講：体重管理とエイジングケア。なぜ美容医療は内側からの管理も大切なの？',
        'beautology-l6-subtitle': '—— 美容医療の診察室から毎日の食卓へ。HANA医師の内外を整える美力観 ——',
        'beautology-l6-desc': '美容医療は輪郭や肌状態へのアプローチを担い、食事、休息、生活リズムは、長く美力を育むための内側の土台になります。',
        'beautology-l6-s1-title': '1. 体重管理は、ただ食べる量を減らすことではない',
        'beautology-l6-s1-text': '大切なのは、食事、睡眠、ストレス、運動を無理なく続けられることです。体重管理の注射を使用中の方、食欲が落ちている方、運動量が増えている方は、食事について医師または管理栄養士にご相談ください。',
        'beautology-l6-s2-title': '2. エイジングケアは、老化を止めることではなく、日々の消耗をいたわること',
        'beautology-l6-s2-text': '美容医療は輪郭、肌質、特定の悩みに寄り添います。紫外線対策、睡眠、規則正しい食事、ストレスケアは、毎日できる長期的なケアです。',
        ...
        'beautology-l6-cta': '公式LINEで日々の栄養補給プランを相談する',
    },
    'en': {
        'nav-home': 'Home',
        ...
        'beautology-lesson-1-title': 'Lesson 1: How Can You Replenish Qi and Blood After Childbirth? A Food-Nourishment Approach Informed by Lactation',
        ...
        'beautology-l1-s1-text': 'In Chinese medicine, the spleen and stomach are often described as the foundation of acquired vitality. Being able to eat and digest comfortably helps the body make use of daily nourishment. Heavy meals can sometimes feel like an added burden.',
        'beautology-l1-s2-title': '2. Why focus on small-molecule nutrition?',
        'beautology-l1-s2-text': 'Chicken essence contains nutrients such as free amino acids in a mellow, convenient format. One pouch a day can be an easy way for busy mothers to include a small moment of nourishment in their routine.',
        ...
        'beautology-lesson-2': 'Lesson 2: How Can You Prepare Your Body Before Pregnancy? Why Silkie Chicken Essence Can Be Part of a Nourishing Foundation',
        'beautology-lesson-3': 'Lesson 3: Why Choose Silkie Chicken for Chicken Essence? “Black Gold” Food Nourishment and Radiance from Within',
        'beautology-lesson-4': 'Lesson 4: How Can You Care for Yourself During the First 60 Days After Childbirth? A Gentle Reset for Energy and Complexion',
        'beautology-l2-subtitle': '— Care for yourself first, so there is room to nurture what comes next —',
        'beautology-l2-desc': 'Preparing to nurture life begins with sleep, meals, emotions, and the energy you have for each day. Chinese medicine often compares the body to soil: when the ground is well cared for, roots can grow strong.',
        ...
        'beautology-l2-s2-text': 'In traditional food nourishment, Silkie chicken has long been valued as a gentle ingredient for women’s everyday care. From a nutrition perspective, it provides protein and amino acids as part of a balanced diet.',
        'beautology-l2-s3-title': '3. Cheng Yun: a nourishing foundation, one pouch at a time',
        'beautology-l2-s3-text': '【Cheng Yun | Original Silkie Chicken Essence】is slowly extracted without added water for 12 hours. Mellow and easy to enjoy, it offers a convenient moment of nourishment for busy days.',
        'beautology-l2-quote': '“Prepare the soil before tending the flower. When the body is cared for, the strength to nurture can grow.” — Dr. HANA',
        ...
        'beautology-l3-s1-text': 'Silkie chicken has long been used in traditional food nourishment for women’s everyday care. Its meaning is not intense supplementation, but gentle, thoughtful care built over time.',
        ...
        'beautology-l3-s3-text': 'One pouch of chicken essence, one proper meal, and one earlier night of rest can all be small steps toward feeling more like yourself.',
        ...
        'beautology-lesson-5': 'Lesson 5: How Many Chicken Essence Pouches a Day? A Guide for Different Life Stages',
        ...
        'beautology-l5-table-context': 'When it may fit', 'beautology-l5-table-amount': 'Daily guide', 'beautology-l5-table-duration': 'How long to increase', 'beautology-l5-table-next': 'Then return to',
        ...
        'beautology-l5-row4-context': 'Preconception, pregnancy, breastfeeding, and postpartum nourishment', 'beautology-l5-row4-amount': '1 pouch daily; up to 1–2 postpartum', 'beautology-l5-row4-duration': 'For the first 2–4 weeks postpartum', 'beautology-l5-row4-next': 'Return to 1 pouch daily once settled',
        'beautology-l5-row5-context': 'Everyday dietary support after surgery or an aesthetic procedure', 'beautology-l5-row5-amount': '1 pouch daily; up to 2 when food intake is low', 'beautology-l5-row5-duration': 'For about 7–14 days', 'beautology-l5-row5-next': 'Return to 1 pouch daily with regular meals',
        'beautology-l5-row6-context': 'Reduced food intake or weight-management periods', 'beautology-l5-row6-amount': '1 pouch daily', 'beautology-l5-row6-duration': 'Observe over 2–4 weeks', 'beautology-l5-row6-next': 'Continue 1 pouch daily once eating is stable',
        ...
        'beautology-l5-safety-title': 'Please note before drinking',
        'beautology-l5-safety-text': 'People with phenylketonuria (PKU), hyperphenylalaninemia, or an inherited metabolic condition requiring a strict low-protein diet should not drink this product without professional advice. If you have kidney disease, high uric acid or gout, a chicken allergy, are pregnant or breastfeeding, are recovering from postpartum bleeding or surgery, or are receiving weight-management treatment, follow the advice of your clinician or dietitian. For children, follow the age guidance and directions on the package; chicken essence is not a replacement for meals or pediatric assessment.',
        ...
        'beautology-l5-cta': 'Join our official LINE to ask our team about your everyday nutrition',
        'beautology-lesson-6': 'Lesson 6: Weight Management and Healthy Aging—Why Medical Aesthetics Also Begins with Inner Care',
        'beautology-l6-subtitle': '— From the aesthetics clinic to the everyday table: Dr. HANA’s integrated view of vital beauty —',
        ...
        'beautology-l6-s1-text': 'The goal is not rapid weight loss, but a pattern of meals, sleep, stress care, and movement that you can sustain. If you use weight-management injections, have a reduced appetite, or have increased your training, discuss your nutrition plan with a clinician or dietitian.',
        'beautology-l6-s2-title': '2. Healthy aging is not about stopping time',
        'beautology-l6-s2-text': 'Medical aesthetics can support concerns related to contour, skin quality, and appearance. Sun protection, sleep, regular meals, and stress care are the long-term choices available every day.',
        ...
        'beautology-l6-cta': 'Ask us on official LINE about an everyday nourishment plan',
    }
};
