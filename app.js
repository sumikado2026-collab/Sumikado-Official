...
const translations = {
    'zh': {
        ...
        'beautology-exp-text': '我曾懷孕三巡、喜得四子。經歷孕育生命的精血損耗與極度疲憊，我仍一邊育兒、一邊迅速重返職場。孕哺期的精力耗竭，與青春逐漸流逝的真實感，驅使我投入「漢方滋養與母乳」的深度研究。我很清楚，撐過這段神聖卻艱辛的過程，如何把自己一點一點地「找回來」，女性需要的不是大負擔的進補，而是「精微物質」的精準運行。',
