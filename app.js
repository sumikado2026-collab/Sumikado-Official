...
const translations = {
    'zh': {
        ...
        'hero-learn': '了解品牌',
        'founder-title': '品牌精神',
        'founder-text': '澄花堂秉持澄淨初心，源於創辦人漢方碩士的涵養，並歷經西醫執業三十年的實證淬鍊。我們以醫師的嚴謹眼光，融合母親般的細緻呵護，親自嚴選每一份安全、純淨的健康聖品。<br><br>台灣窗花，是家戶間交織而成的守護意象。澄花堂以此為印記，擷取這片土地的溫潤精華，在您每一個需要力量的時刻，願成為您最優雅且堅實的元氣補給。',
    ...
    'ja': {
        ...
        'founder-text': '澄花堂は澄み渡る初心を抱き、漢方医学修士の知見と三十年にわたる西洋医学の臨床経験を持つ創設者の想いから誕生しました。医師としての厳格な視点と、母親のような細やかな愛情を融合させ、安全で純粋な健康の逸品を自ら厳選しています。<br><br>台湾の窓飾りは、家庭の間で織りなされる守護の象徴です。澄花堂はこの伝統を印とし、この土地の温もりある精華を抽出しました。力が必要なその瞬間に、あなたにとって最も優雅で心強い活力の補給となることを願っています。',
    ...
    'en': {
        ...
        'founder-text': "Sumikado upholds a heart of crystalline purity, rooted in our founder's Master's degree in Chinese medicine and refined through thirty years of clinical practice in Western medicine. With a physician's rigor and a mother's tenderness, we personally select health treasures that are safe and pure.<br><br>The Taiwanese window grille is an icon of protection woven between households. Sumikado adopts this as our mark, capturing the gentle essence of this land. In every moment you need strength, we aspire to be your most elegant and steadfast source of vitality.",
