...
const translations = {
    ...
    'ja': {
        ...
        'brand-story-item-title': '滴養之道',
        'brand-story-item-text': '澄花堂では、真の健康に近道はないと信じています。チキンエッセンスの一滴一滴は、「滴養之道」を着実に歩んだ結果です。花蓮の清らかな大地で120日間放牧飼育され、12時間の無水抽出は、単なる濃縮ではなく、職人の魂の結晶です。',
    ...
    'en': {
        ...
        'brand-story-item-text': 'At Sumikado, we believe there are no shortcuts to true health. Each pack is born from persistent progress on "The Path of Essence". Pasture-raised in the pure lands of Hualien for 120 days, we adhere to 12 hours of waterless extraction as the crystallization of craftsmanship.',
