...
const translations = {
    'zh': {
        ...
        'beautology-exp-text': '我曾懷孕三巡、喜得四子。在經歷過孕育生命帶來的精血損耗與極度疲憊後，我仍選擇一邊育兒、一邊迅速重返職場。那段哺乳期帶來的精力耗竭，以及青春流逝的真實感，驅使我投入「漢方滋養與母乳」的深度研究。我比誰都清楚，從懷孕到哺乳這段神聖卻艱辛的過程，女性需要的不是大負擔的進補，而是「精微物質」的精準運行。',
        ...
        'beautology-l1-s1-text': '漢醫認為「乳汁為氣血所化」，產後女性面臨巨大的能量挪用。我們選用台灣原生古早雞強化脾胃運化，確保營養能轉化為優質乳汁；並以烏骨雞（黑金）滋陰養血，其鐵、鋅含量高於一般雞種 2-3 倍，能有效修復母體損耗，並將營養傳遞給寶寶。',
        'beautology-l1-s2-title': '2. 精微物質的運行：小分子胜肽的力量',
        'beautology-l1-s2-text': '產後脾胃虛弱，大魚大肉易造成負擔。我們透過恆溫滴製技術，將大分子蛋白質轉化為小分子胺基酸與膠原胜肽。這些精微物質能繞過消化門檻，直達細胞修復底層，實現「補而不燥、潤而不膩」的精準調養。',
        'beautology-l1-s3-title': '3. 澄韻與澄潤：內在美力的雙重應援',
        'beautology-l1-s3-text': '結合學理與三次分娩實證，我開發了兩款精準處方：【澄韻｜元氣之雫】以烏骨雞為主，側重益氣，助妳補足產後中氣；【澄潤｜豐美之雫】以台灣原生種古早雞為主，側重滋陰，添加膠原蛋白，專為產後氣色修復而生。',
    ...
    'ja': {
        ...
        'beautology-l1-s3-text': '実証データに基づき、2種類の処方を開発しました。<br><strong>【澄韻｜元気の雫】：</strong> 烏骨鶏を主とし「益気」に重点。産前産後の体力維持に。<br><strong>【澄潤｜豊美の雫】：</strong> 台湾原生種古早鶏を主とし「滋陰」に重点。コラーゲン配合で産後のくすみと構造の修復に。',
        ...
        'beautology-lesson-3': '第3回：ブラックゴールドの滋陰学 — 烏骨鶏とあなたに贈る豊美の雫。',
    ...
    'en': {
        ...
        'beautology-l1-s3-text': 'Based on three successful births, I formulated two precise treatments:<br><strong>【Cheng Yun | Essence of Qi】：</strong> Based on Silkie chicken, focuses on "Qi" for stamina during and after pregnancy.<br><strong>【Cheng Run | Abundant Glow】：</strong> Based on Taiwan Native Ancient Breed chicken, focuses on "Yin" with added collagen for structural repair and radiance.',
        ...
        'beautology-lesson-3': 'Lesson 3: The Yin Science of Silkie Chicken Essence — Abundant Glow.',
